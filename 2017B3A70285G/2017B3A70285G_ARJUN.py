...
class Puzzle:
	...
	def _a_star(self):
		...
		heappush(frontier, (init_heuristic_cost, init_heuristic_cost, self.init_state, ''))
...
def ReadInitialState():
	...
	with open("test_state5.txt", "r") as file:  # IMP: If you change the file name, then there will be an error when
